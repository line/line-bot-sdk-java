...
public class VideoMessageTest {
    ...
    public void constructor() {
        VideoMessage message = new VideoMessage(URI.create("https://example.com/"),
                                                URI.create("https://example.com/preview"));
        assertThat(message.getOriginalContentUrl()).isEqualTo(URI.create("https://example.com/"));
        assertThat(message.getPreviewImageUrl()).isEqualTo(URI.create("https://example.com/preview"));
