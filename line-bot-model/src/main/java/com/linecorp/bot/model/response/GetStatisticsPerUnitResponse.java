...
import com.linecorp.bot.model.response.GetStatisticsPerUnitResponse.GetStatisticsPerUnitResponseBuilder;
...
@Value
@Builder
@JsonDeserialize(builder = GetStatisticsPerUnitResponseBuilder.class)
public class GetStatisticsPerUnitResponse {
    ...
    @JsonPOJOBuilder(withPrefix = "")
    public static class GetStatisticsPerUnitResponseBuilder {
        // Filled by lombok
    }
}
