...
public record ImageSet(
     ...
     * Only included when multiple images are sent simultaneously. However, it won&#39;t be included
     * if the sender is using LINE 11.15 or earlier for Android.
     */
  ...
  public static class Builder {
    ...
    public ImageSet build() {
      ...
      return new ImageSet(id, index, total);
    }
  }
}
