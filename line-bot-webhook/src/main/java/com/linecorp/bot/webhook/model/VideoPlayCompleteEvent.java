...
public Builder videoPlayComplete(VideoPlayComplete videoPlayComplete) {
        ...
        public VideoPlayCompleteEvent build() {
            ...
            if (!this.deliveryContext$set) {
                throw new IllegalStateException("'deliveryContext' must be set for VideoPlayCompleteEvent.");
            }
            ...
            if (!this.videoPlayComplete$set) {
                throw new IllegalStateException("'videoPlayComplete' must be set for VideoPlayCompleteEvent.");
            }
