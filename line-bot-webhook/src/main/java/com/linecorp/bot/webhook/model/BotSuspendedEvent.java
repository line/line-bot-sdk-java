...
/**
 * This event indicates that the LINE Official Account has been suspended (Suspend). Sent to the
 * webhook URL server of the module channel.
 */
...
public record BotSuspendedEvent(
  ...
  public static class Builder {
    ...
    public BotSuspendedEvent build() {
      ...
      return new BotSuspendedEvent(source, timestamp, mode, webhookEventId, deliveryContext);
    }
  }
}
