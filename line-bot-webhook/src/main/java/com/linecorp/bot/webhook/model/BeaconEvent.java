...
private BeaconContent beacon;
    
        private boolean beacon$set;
...
public Builder beacon(BeaconContent beacon) {
            this.beacon = beacon;
    
            this.beacon$set = true;
        ...
        public BeaconEvent build() {
            ...
            if (!this.timestamp$set) {
                throw new IllegalStateException("'timestamp' must be set for BeaconEvent.");
            }
    

            if (!this.mode$set) {
                throw new IllegalStateException("'mode' must be set for BeaconEvent.");
            }
    

            if (!this.webhookEventId$set) {
                throw new IllegalStateException("'webhookEventId' must be set for BeaconEvent.");
            }
    

            if (!this.deliveryContext$set) {
                throw new IllegalStateException("'deliveryContext' must be set for BeaconEvent.");
            }
    

            if (!this.replyToken$set) {
                throw new IllegalStateException("'replyToken' must be set for BeaconEvent.");
            }
    

            if (!this.beacon$set) {
                throw new IllegalStateException("'beacon' must be set for BeaconEvent.");
            }
    


            return new BeaconEvent(
source,timestamp,mode,webhookEventId,deliveryContext,replyToken,beacon
            );
        }
    }
}
