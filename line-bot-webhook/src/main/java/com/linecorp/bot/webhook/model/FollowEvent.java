...
public Builder replyToken(String replyToken) {
        ...
        public FollowEvent build() {
            ...
            if (!this.timestamp$set) {
                throw new IllegalStateException("'timestamp' must be set for FollowEvent.");
            }
    

            if (!this.mode$set) {
                throw new IllegalStateException("'mode' must be set for FollowEvent.");
            }
    

            if (!this.webhookEventId$set) {
                throw new IllegalStateException("'webhookEventId' must be set for FollowEvent.");
            }
    

            if (!this.deliveryContext$set) {
                throw new IllegalStateException("'deliveryContext' must be set for FollowEvent.");
            }
    

            if (!this.replyToken$set) {
                throw new IllegalStateException("'replyToken' must be set for FollowEvent.");
            }
    


            return new FollowEvent(
source,timestamp,mode,webhookEventId,deliveryContext,replyToken
            );
        }
    }
}
