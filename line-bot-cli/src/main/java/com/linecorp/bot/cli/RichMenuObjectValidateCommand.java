...
@Slf4j
@Component
@ConditionalOnProperty(name = "command", havingValue = "richmenu-object-validate")
@AllArgsConstructor(onConstructor = @__(@Autowired))
public class RichMenuObjectValidateCommand implements CliCommand {
    ...
    public void execute() {
        ...
        final BotApiResponse botApiResponse =
                getUnchecked(lineMessagingClient.validateRichMenuObject(richMenu));
