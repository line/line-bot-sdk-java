 ...
 * TemplateMessage
 *
 * @see <a href="https://developers.line.biz/en/reference/messaging-api/#template-messages">
 *     Documentation</a>
 */
...
public record TemplateMessage(
  ...
  public static class Builder {
    ...
    public Builder(String altText, Template template) {
    ...
    public TemplateMessage build() {
      return new TemplateMessage(quickReply, sender, altText, template);
    }
  }
}
