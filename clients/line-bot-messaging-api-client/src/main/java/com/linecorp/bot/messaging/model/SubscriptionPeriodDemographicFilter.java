...
public record SubscriptionPeriodDemographicFilter(
    /** Get gte */
    @JsonProperty("gte") SubscriptionPeriodDemographic gte,
    /** Get lt */
    @JsonProperty("lt") SubscriptionPeriodDemographic lt)
  ...
  public static class Builder {
    ...
    public SubscriptionPeriodDemographicFilter build() {
      return new SubscriptionPeriodDemographicFilter(gte, lt);
    }
  }
}
