...
public record GetRichMenuInsightSummaryResponseMetrics(
  ...
  public static class Builder {
    ...
    public Builder(Long count, Long uniqueUsers) {
    ...
    public GetRichMenuInsightSummaryResponseMetrics build() {
      return new GetRichMenuInsightSummaryResponseMetrics(count, uniqueUsers);
    }
  }
}
