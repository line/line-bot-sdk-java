...
public interface ManageAudienceClient {
  ...
  CompletableFuture<Result<Void>> addAudienceToAudienceGroup(
      @Body AddAudienceToAudienceGroupRequest addAudienceToAudienceGroupRequest);
  ...
  CompletableFuture<Result<CreateAudienceGroupResponse>> createAudienceGroup(
      @Body CreateAudienceGroupRequest createAudienceGroupRequest);
   ...
   * @see <a
   *     href="https://developers.line.biz/en/reference/messaging-api/#create-click-audience-group">
   *     Documentation</a>
   */
  @POST("/v2/bot/audienceGroup/click")
  CompletableFuture<Result<CreateClickBasedAudienceGroupResponse>> createClickBasedAudienceGroup(
      @Body CreateClickBasedAudienceGroupRequest createClickBasedAudienceGroupRequest);
   ...
   * @see <a
   *     href="https://developers.line.biz/en/reference/messaging-api/#create-imp-audience-group">
   *     Documentation</a>
   */
  @POST("/v2/bot/audienceGroup/imp")
  CompletableFuture<Result<CreateImpBasedAudienceGroupResponse>> createImpBasedAudienceGroup(
      @Body CreateImpBasedAudienceGroupRequest createImpBasedAudienceGroupRequest);
  ...
  CompletableFuture<Result<Void>> deleteAudienceGroup(
      @Path("audienceGroupId") Long audienceGroupId);
   ...
   * @param includesExternalPublicGroups true (default): Get public audiences created in all
   *     channels linked to the same bot. false: Get audiences created in the same channel.
   *     (optional)
  ...
  CompletableFuture<Result<GetAudienceGroupsResponse>> getAudienceGroups(
  ...
  CompletableFuture<Result<Void>> updateAudienceGroupDescription(
      @Path("audienceGroupId") Long audienceGroupId,
  ...
  public static ApiAuthenticatedClientBuilder<ManageAudienceClient> builder(String channelToken) {
    return new ApiAuthenticatedClientBuilder<>(
        ...
        ManageAudienceClient.class,
        new ManageAudienceExceptionBuilder(),
        channelToken);
  }

  public static ApiAuthenticatedClientBuilder<ManageAudienceClient> builder(
