...
public class ManageAudienceExceptionBuilder extends AbstractExceptionBuilder<ErrorResponse> {
    public ManageAudienceExceptionBuilder() {
        super(ErrorResponse.class);
    }

    @Override
    protected IOException buildException(Response response, ErrorResponse errorBody) {
        return new ManageAudienceClientException(
                response,
