...
public record CreateClickBasedAudienceGroupResponse(
    ...
    /**
     * How the audience was created. &#x60;MESSAGING_API&#x60;: An audience created with Messaging
     * API.
     */
    @JsonProperty("createRoute") CreateRoute createRoute,
    /**
     * Audience&#39;s update permission. Audiences linked to the same channel will be READ_WRITE. -
     * &#x60;READ&#x60;: Can use only. - &#x60;READ_WRITE&#x60;: Can use and update.
     */
     ...
     * for uploading user IDs. One of: true: Accounts are specified with IFAs. false (default):
     * Accounts are specified with user IDs.
     */
