...
public class ChannelAccessTokenExceptionBuilder extends AbstractExceptionBuilder<ErrorResponse> {
    ...
    protected IOException buildException(Response response, ErrorResponse errorBody) {
        return new ChannelAccessTokenClientException(
                response,
                errorBody.error(), errorBody.errorDescription());
    }
}
