    ...
    public IssueStatelessChannelAccessTokenResponse build() {
      ...
      if (!this.accessToken$set) {
        throw new IllegalStateException(
            "'accessToken' must be set for IssueStatelessChannelAccessTokenResponse.");
      }

      if (!this.expiresIn$set) {
        throw new IllegalStateException(
            "'expiresIn' must be set for IssueStatelessChannelAccessTokenResponse.");
      }

      if (!this.tokenType$set) {
        throw new IllegalStateException(
            "'tokenType' must be set for IssueStatelessChannelAccessTokenResponse.");
      }
