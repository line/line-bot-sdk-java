...
public interface ShopClient {
  ...
  CompletableFuture<Result<Void>> missionStickerV3(
      @Body MissionStickerRequest missionStickerRequest);
  ...
  public static ApiAuthenticatedClientBuilder<ShopClient> builder(String channelToken) {
    return new ApiAuthenticatedClientBuilder<>(
        ...
        ShopClient.class,
        new ShopExceptionBuilder(),
        channelToken);
  }

  public static ApiAuthenticatedClientBuilder<ShopClient> builder(
